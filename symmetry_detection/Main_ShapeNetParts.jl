...
@everywhere function main(path2obj, modelname)
	for partnum = 0:50
	    ...
	    logname = "/orions4-zfs/projects/anastasiad/ShapeNet-symmetry/Results/03001627_v2/" * modelname * "_$partnum.log"
	    println(logname)
	    fout = open(logname, "w")
	    symType, canonical, translate = detectSelfSymmetry(newMesh, fout)
	    close(fout)
	    symname = "/orions4-zfs/projects/anastasiad/ShapeNet-symmetry/Results/03001627_v2/" * modelname * "_$partnum.sym"
	    println(symname)
